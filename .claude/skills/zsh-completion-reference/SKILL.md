---
name: zsh-completion-reference
description: Zsh completion 编写参考手册——_arguments/_describe/_alternative/_regex_arguments/_values/compadd 等工具函数用法、ACTION 形式、官方风格约定与调试操作。编写、审查或调试 _claude 补全脚本时调用。
---
...
# 逐段补全 MAC 地址
_multi_parts : '(00:11:22:33:44:55 00:23:45:56:67:89)'
```
...
以下摘录自 [Zsh Completion Style Guide](https://github.com/zsh-users/zsh/blob/master/Etc/completion-style-guide)，作为补全脚本的书写规范。
